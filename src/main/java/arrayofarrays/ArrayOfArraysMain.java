...
public class ArrayOfArraysMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tömbök tömbje gyakorlófeladat v0.1");

        System.out.println(" ");

        System.out.println("Szorzótábla");
        arrayOfArraysMain.printArrayOfArrays(arrayOfArraysMain.multiplicationTable(16));

        System.out.println(" ");

        System.out.println("Háromszögmátrix");
        arrayOfArraysMain.printArrayOfArrays(arrayOfArraysMain.triangularMatrix(16));
