...
public class Orders {
    ...
    public void readFile(Path path) {
        try (BufferedReader br = Files.newBufferedReader(path)) {
            ...
            throw new IllegalStateException("Where is the motherfucker file again?", ioe);
        }
        makeProductList();
    }
    ...
    public int productFinder(String name) {
        if (productList.get(name) != null) {
            ...
            throw new IllegalArgumentException("Fucking product not found!");
        }
    }
    ...
    public int numOfProductByName(String name) {
        if (orderList.get(name) != null) {
            ...
            throw new IllegalArgumentException("Your fucking order not found!");
        }
    }
    ...
    private void isError() {
        if (orderList.isEmpty() || productList.isEmpty()) {
            throw new IllegalStateException("Your bitch-list is empty!");
        }
    }
}