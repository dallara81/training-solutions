...
public class Main {
    ...
    public List<Integer> getIndexesOfChar1(String str, char c) {    // indexOf
    ...
    public List<Integer> getIndexesOfChar2(String str, char c) {    // charAt
        List<Integer> result = new ArrayList<>();
    ...
    public List<Integer> getIndexesOfChar3(String str, char c) {    // recursive
        List<Integer> result = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        String [] strarray ={ "bizergebazerga", "törökcsászár", "kabátja", ""};
        char c = 't';
