...
public class DayInMonthTest {
    ...
    public void testNumberOfDays() {
        ...
        assertEquals(31, new DayInMonth().numberOfDays(1917, "május"));
        assertEquals(30, new DayInMonth().numberOfDays(1917, "június"));
        assertEquals(28, new DayInMonth().numberOfDays(1917, "február"));
